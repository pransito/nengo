...
with model:
    ...
    for i in range(1000):
        ...
        DAencoders.append([x,y])  # add the encoder
    ...
    for i in range(1000):
        ...
        Serencoders.append([x,y])  # add the encoder
    ...
    DA = nengo.Ensemble(n_neurons=1000, dimensions=2, radius = 1,
    intercepts=nengo.dists.Uniform(0, 1), encoders = DAencoders)
    Ser = nengo.Ensemble(n_neurons=1000, dimensions=2,radius = 1,
    ...
    #nengo.Connection(Ser_Eneg,DA[1],function= E_pl_func)
