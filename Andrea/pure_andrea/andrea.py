...
with model:
	...
	#voltage    = nengo.Probe(amyg.neurons, 'voltage')  # Subthreshold soma voltage of the neuron
	...
	# FELIX: print the simulation output to a file [AMYGDALA!]
	# fid = fopen('filename.txt')
	# fwrite(fid,'ofc_integrator' '\t')
	# fwrite(fid,sim.data[filt_ofc_i])
